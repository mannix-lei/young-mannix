...
const SongsHome: FC = () => {
    ...
    return (
        <div className={style.body}>
            <Card hoverable className={style.card} cover={<img alt="hotImg" src={hotImg} />} onClick={() => history.push('/songs/list') }>
                <Meta title={<Link to={'/list'}>songs list</Link>} description="Popular playlist" />
            </Card>
            <Card hoverable className={style.card} cover={<img alt="listImg" src={listImg} />} onClick={() => history.push('/songs/hot') }>
